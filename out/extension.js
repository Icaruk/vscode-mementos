...
const generateSvg = ({ text, fillRgb = "25,25,25", textRgb = "255,255,255", }) => {
...
function activate(context) {
    ...
    nodeDependenciesProvider = new nodeDependencies_1.DepNodeProvider(allMementos);
    vscode_1.window.registerTreeDataProvider('nodeDependencies', nodeDependenciesProvider);
...
function updateDecorations(editor) {
    ...
    for (let lineNumber = 0; lineNumber < lineCount; lineNumber++) {
        ...
        if (magicWord === "@mem") {
            ...
            const decType = vscode_1.window.createTextEditorDecorationType({
            ...
            editor.setDecorations(decType, [
                {
                    range: new vscode_1.Range(lineNumber, 0, lineNumber, 0),
                },
            ]);

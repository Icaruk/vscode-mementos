...
function getTextColorForBackground(backgroundRgb) {
    // Convertir el fondoRGB a un arreglo de números
...
function activate(context) {
    vscode.window.showInformationMessage('Mementos has been started');
    ...
    let disposable = vscode.commands.registerCommand('mementos.helloWorld', () => {
        vscode.window.showInformationMessage('333');
    });
...
function updateDecorations(editor) {
    ...
    for (let lineNumber = 0; lineNumber < lineCount; lineNumber++) {
        ...
        // Check regex if line includes // @mem:asd qwe
